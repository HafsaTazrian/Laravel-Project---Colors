            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3" style="background-color: #fbfada;">
                ...
                <div class="card-body" >
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4" style="color: #12372A;">Reset Password</h5>
                  </div>
                  ...
                  <div class="col-12">
                      <label for="Password" class="form-label" style="color: #436850;">Password</label>
                      <input type="password" name="password" class="form-control" id="Password" required>
                      <div class="invalid-feedback" style="color: #436850;">Please enter a valid Email adddress!</div>
                    </div>

                    <div class="col-12">
                      <label for="Password" class="form-label" style="color: #436850;">Confirm Password</label>
